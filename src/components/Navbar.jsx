...
const Navbar = () => {
    ...
    <div className='flex justify-between items-center w-full h-20 px-4 text-white bg-black fixed top-0 z-50'>
        ...
        <div className='flex flex-row md:hidden'>
            {socials.map(({id, text, child, href, altStyle, download}) => (
                <span key={id} title={text} className={"flex justify-between items-center h-12 px-4 bg-teal-500 hover:bg-teal-800 " + altStyle}>
